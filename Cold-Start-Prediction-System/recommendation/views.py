...
from recommendation.forms import RegistrationForm, LoginForm, ProductForm, CommentForm, RatingForm

from recommendation.models import RegistrationModel, ProductModel, CommentModel, RatingModel, SearchHistoryModel, \
    TransactionModel
from recommendation.service import getAllProducts, findrecommendations, getProductById
...
def home(request):
    return HttpResponse("Our major Project")
